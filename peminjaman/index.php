                  ...
                  <tr>
                      ...
                      <?php 
                          ...
                          while($key = mysqli_fetch_array($anggota)) {
                            if ($key['id_anggota'] == $row['id_anggota']) { ?>
                            <?php echo $key['nama']; ?>
                            <?php 
                            }
                          }
                      ...
                      <?php 
                          ...
                          while($key = mysqli_fetch_array($petugas)) {
                            if ($key['id_petugas'] == $row['id_petugas']) { ?>
                            <?php echo $key['nama_petugas']; ?>
                            <?php 
                            }
                          }
                          ?>
                      ...
                      <td class="text-center">
                        <a href="edit.php?id=<?php echo $row['id_peminjaman'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                        <a href="hapus.php?id=<?php echo $row['id_peminjaman'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                      </td>
                  </tr>
